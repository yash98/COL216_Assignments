...
input_keyboard:
    ...
    r5 = number input
    r6 = 0x1 constant
    r7 = store to be returned value */
    stmfd sp!, {r4, r5, r6, r7}

input_keyboard_start:
    mov r0, #0
    swi SWI_Black
    cmp r0, #1
    beq main
...
checkPlace_for1:
    @ load tx, ty
    ldr r3, [r12, r10, lsl#2]
    add r5, r8, r3
    add r10, r10, #1

    ldr r4, [r12, r10, lsl#2]
    add r6, r9, r4
    add r10, r10, #1
